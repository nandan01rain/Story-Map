-- Character web, sixth pass: mythic threads.
--
...
-- drifts.
--
-- **This file supersedes 20260822_graph_flags.sql and 20260822b_graph_structure.sql
-- entirely.** If none of the three has been run, run only this one.
--
...
as $$
  ...
  flag_rows as (
    select
      ...
      nullif(a ->> 'pairLabel', '') as pair_label,
