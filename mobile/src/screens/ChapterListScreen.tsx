...
export default function ChapterListScreen({ route, navigation }: Props) {
  ...
  const drawer = (
    <>
      ...
      onOpenReport={() => navigateFromDrawer(() => navigation.navigate('ProseReport', { projectId }))}
      onOpenChronology={() => navigateFromDrawer(() => navigation.navigate('Chronology', { projectId }))}
      ...
      onOpenStoryboard={() => navigateFromDrawer(() => navigation.navigate('Storyboard', { projectId }))}
